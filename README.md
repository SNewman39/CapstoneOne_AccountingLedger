The application allows users to perform basic banking actions such as depositing money, making payments (debiting), viewing a ledger (transaction history), and exiting the program.
## Features
